// Skeleton para paginas de servicio (vehiculos/cardetailing/home & deco).
    ...
    <div className="animate-pulse">
      ...
      <div className="mx-auto max-w-[1200px] space-y-10 px-5 py-10 sm:px-8 lg:px-10">
        <section className="grid gap-6 md:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              <div className="h-11 w-32 rounded-xl bg-slate-200 dark:bg-slate-700" />
        ...
        <section>
          ...
          <div className="mt-3 h-10 w-full max-w-2xl rounded bg-slate-200 dark:bg-slate-700" />
          <div className="mt-2 h-5 w-full max-w-xl rounded bg-slate-200 dark:bg-slate-700" />
