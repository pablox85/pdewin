...
export function HeroSection() {
  return (
    <SectionWrapper className="relative overflow-hidden bg-gradient-to-br from-brand-50 via-white to-slate-100 pt-20 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800">
      <div
        className="ambient-orb absolute -left-20 top-0 hidden h-56 w-56 rounded-full bg-brand-100/70 blur-3xl dark:bg-blue-700/30 sm:block"
        aria-hidden="true"
      />
      <div
        className="ambient-orb ambient-orb--slow absolute right-0 top-10 hidden h-48 w-48 rounded-full bg-slate-200/60 blur-3xl dark:bg-slate-600/30 sm:block"
        aria-hidden="true"
      />
